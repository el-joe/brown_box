...
<head>
    ...
    <title>{{ __('Admin Login') }} — Brown Box</title>
    ...
    <div class="w-full max-w-md">
        ...
        <div class="bg-white shadow-lg rounded-xl p-8">
            ...
            <form method="POST" action="{{ route('admin.login.store') }}">
                ...
                <button type="submit"
                    class="w-full inline-flex items-center justify-center gap-2 rounded-lg bg-amber-600 hover:bg-amber-700 text-white font-medium py-2.5 text-sm transition">
